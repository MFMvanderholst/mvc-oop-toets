...
--
-- Host: 127.0.0.1:3306
-- Gegenereerd op: 14 mrt 2023 om 10:43
-- Serverversie: 8.0.27
-- PHP-versie: 8.1.0
...
CREATE TABLE IF NOT EXISTS `zangeres` (
  ...
  `Land` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `Mobiel` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
(3, 'Taylor Swift', 570, 'Verrenigde Staten', '+1 5876 236512', 33),
(4, 'Beyoncé', 420, 'Veregide Staten', '+1 6794 908465', 41),
